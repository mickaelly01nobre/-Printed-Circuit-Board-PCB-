...
(library Library_1
	...
	(compDef "C0805C476M9PAC7800" (originalName "C0805C476M9PAC7800") (compHeader (numPins 2) (numParts 1) (refDesPrefix C)
		...
		(attr "<Hyperlink>" "https://connect.kemet.com:7667/gateway/IntelliData-ComponentDocumentation/1.0/download/specsheet/C0805C476M9PACTU")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "C0805C476M9PAC7800.stp")
